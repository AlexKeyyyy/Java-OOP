...
public class Main {
    public static void main(String[] args)
    {
        ...
        List<String> strings = Arrays.asList("azily", "apple", "banana", "cherry", "date", "apple", "banana", "java");
        List<String> strings1 = Arrays.asList("azily", "apple", "banana", "cherry", "date", "apple", "banana", "java");
        List<String> strings2 = Arrays.asList();
        int[] numbersArr = {1, 2, 3, 4, 5, 6, 7, 8, 9};

        System.out.println("1. Среднее целых чисел: " + StreamMethods.averageOfList(numbers));
        ...
        try
        {
            System.out.println("5. Последний элемент (есть): " + StreamMethods.getLastElement(strings1));
        } catch (NoSuchElementException e) {
            System.err.println(e.getMessage());
        }
        try
        {
            System.out.println("5. Последний элемент (нет): " + StreamMethods.getLastElement(strings2));
        } catch (NoSuchElementException e) {
            System.err.println(e.getMessage());
        }
